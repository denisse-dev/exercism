...
var testData = []testCase{
	...
	{Deg, 3, 6, 3},    // a "triangle" that is just a line is still OK
	{Deg, 2, 1, 1},    // a "triangle" that is just a line is still OK
	{Deg, 8, 4, 4},    // a "triangle" that is just a line is still OK
